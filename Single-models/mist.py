...
class master_query(Sim.Process) :
	...
	def run(self, request_query) :
		while(1) :
			...
			yield Sim.hold,self, 975 + constant.RND.expovariate(constant.QUERY_RATE)
...
class processor(Sim.Process) :
	...
	def run(self, node_no) :
		while(1) :
			...
			yield Sim.hold,self,0.5/constant.fact + constant.MIST_PROC_RATE
...
class disk(Sim.Process) :
	...
	def run(self, node_no) :
		while(1) :
			...
			yield Sim.hold,self,0.5/constant.fact+constant.MIST_DISK_RATE
			#except:
			#	print("exception")
